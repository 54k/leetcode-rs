...
public class Day410 {
    ...
    // https://leetcode.com/problems/uncrossed-lines/descriptions
    static class Solution5 {
        int solve(int i, int j, int[] nums1, int[] nums2, int[][] memo) {
            if (i <= 0 || j <= 0) {
                return 0;
            }
        ...
        public int maxUncrossedLinesTopDown(int[] nums1, int[] nums2) {
            int n1 = nums1.length;
            int n2 = nums2.length;
