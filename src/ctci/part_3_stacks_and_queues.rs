...
// 3.2 Как реализовать стек, в котором кроме стандартных функций push и pop будет поддерживаться
...
// 3.4 Напишите класс MyQueue, который реализует очередь с использование двух стеков
struct Node {
    value: i32,
...
// 3.5 Напишите программу сортировки стека,
...
// 3.6 Реализуйте приют для животных
trait Shelter {
